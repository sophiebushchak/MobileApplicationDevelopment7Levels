...
class MakeExampleQuiz {
    companion object {
        fun getAQuiz(): Quiz {
            val quiz = Quiz("Trivia Quiz", "Lorem ipsum dolor sit amet," +
            ...
            quiz.addQuestion(
                QuizQuestion("How many colors are there in the rainbow?",
                listOf(
                    answer1,
                    answer2,
                    answer3
            ...
            quiz.addQuestion(
                QuizQuestion("What is the biggest animal in the world?",
                    listOf(
                        answer1,
                        answer2,
                        answer3
            ...
            quiz.addQuestion(
                QuizQuestion("Which of these animals do NOT appear in the Chinese zodiac?",
                    listOf(
                        answer1,
                        answer2,
                        answer3,
